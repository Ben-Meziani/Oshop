<section class="hero">
  <div class="container">
    ...
    <div class="hero-content pb-5 text-center">
      <?php if($viewVars["type"]->getName() !== null) : ?>
      ...
      <div class="dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
          <a class="dropdown-item"
            href="<?= $_SERVER['BASE_URI'] ?>/catalog/type/<?= $viewVars['type']->getId() ?>?order=price">Prix</a>
          <a class="dropdown-item"
            href="<?= $_SERVER['BASE_URI'] ?>/catalog/type/<?= $viewVars['type']->getId() ?>?order=rate">Popularité</a>
        </div>
      </div>
      <!-- Dropdown -->
